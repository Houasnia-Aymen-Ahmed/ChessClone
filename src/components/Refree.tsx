...
import { PieceType, TeamType } from "../constants/Types";
      ...
      <div className="modal hidden" ref={modalRef}>
        <div className="modal-body">
          <img
            ...
            src={`/assets/svg/rook_${promotionTeamType()}.svg`}
          />
          <img
            onClick={() => promotePawn(PieceType.BISHOP)}
            src={`/assets/svg/bishop_${promotionTeamType()}.svg`}
          />
          <img
            onClick={() => promotePawn(PieceType.KNIGHT)}
            src={`/assets/svg/knight_${promotionTeamType()}.svg`}
          />
          <img
            onClick={() => promotePawn(PieceType.QUEEN)}
            src={`/assets/svg/queen_${promotionTeamType()}.svg`}
          />
        </div>
      </div>
